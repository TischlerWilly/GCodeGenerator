...
namespace {
struct qt_meta_tag_ZN21Dialog_RechtecktascheE_t {};
} // unnamed namespace

template <> constexpr inline auto Dialog_Rechtecktasche::qt_create_metaobjectdata<qt_meta_tag_ZN21Dialog_RechtecktascheE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Dialog_Rechtecktasche, qt_meta_tag_ZN21Dialog_RechtecktascheE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dialog_Rechtecktasche::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21Dialog_RechtecktascheE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21Dialog_RechtecktascheE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21Dialog_RechtecktascheE_t>.metaTypes,
    nullptr
} };

void Dialog_Rechtecktasche::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<Dialog_Rechtecktasche *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dialog_Rechtecktasche::*)(QString )>(_a, &Dialog_Rechtecktasche::sendDialogData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Rechtecktasche::*)(QString )>(_a, &Dialog_Rechtecktasche::sendDialogDataModifyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Rechtecktasche::*)(QString )>(_a, &Dialog_Rechtecktasche::signalSaveConfig, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Rechtecktasche::*)(QString , QString )>(_a, &Dialog_Rechtecktasche::signalBraucheWerkzeugdaten, 3))
            return;
    }
}
...
void *Dialog_Rechtecktasche::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21Dialog_RechtecktascheE_t>.strings))
