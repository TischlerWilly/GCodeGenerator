...
namespace {
struct qt_meta_tag_ZN16Dialog_KommentarE_t {};
} // unnamed namespace

template <> constexpr inline auto Dialog_Kommentar::qt_create_metaobjectdata<qt_meta_tag_ZN16Dialog_KommentarE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Dialog_Kommentar, qt_meta_tag_ZN16Dialog_KommentarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dialog_Kommentar::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16Dialog_KommentarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16Dialog_KommentarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16Dialog_KommentarE_t>.metaTypes,
    nullptr
} };

void Dialog_Kommentar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<Dialog_Kommentar *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dialog_Kommentar::*)(QString )>(_a, &Dialog_Kommentar::sendDialogData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Kommentar::*)(QString )>(_a, &Dialog_Kommentar::sendDialogDataModifyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Kommentar::*)(QString )>(_a, &Dialog_Kommentar::signalSaveConfig, 2))
            return;
    }
}
...
void *Dialog_Kommentar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16Dialog_KommentarE_t>.strings))
