...
namespace {
struct qt_meta_tag_ZN21Dialog_fraeser_geradeE_t {};
} // unnamed namespace

template <> constexpr inline auto Dialog_fraeser_gerade::qt_create_metaobjectdata<qt_meta_tag_ZN21Dialog_fraeser_geradeE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'getDialogData'
        QtMocHelpers::SlotData<void(QString, bool)>(9, 2, QMC::AccessPublic, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<Dialog_fraeser_gerade, qt_meta_tag_ZN21Dialog_fraeser_geradeE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dialog_fraeser_gerade::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21Dialog_fraeser_geradeE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21Dialog_fraeser_geradeE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21Dialog_fraeser_geradeE_t>.metaTypes,
    nullptr
} };

void Dialog_fraeser_gerade::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<Dialog_fraeser_gerade *>(_o);
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->getDialogData((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<bool>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dialog_fraeser_gerade::*)(QString )>(_a, &Dialog_fraeser_gerade::sendDialogData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_fraeser_gerade::*)(QString )>(_a, &Dialog_fraeser_gerade::sendDialogDataModifyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_fraeser_gerade::*)(QString )>(_a, &Dialog_fraeser_gerade::signalSaveConfig, 2))
            return;
    }
}
...
void *Dialog_fraeser_gerade::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21Dialog_fraeser_geradeE_t>.strings))
