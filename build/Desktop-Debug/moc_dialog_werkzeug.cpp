...
namespace {
struct qt_meta_tag_ZN15Dialog_WerkzeugE_t {};
} // unnamed namespace

template <> constexpr inline auto Dialog_Werkzeug::qt_create_metaobjectdata<qt_meta_tag_ZN15Dialog_WerkzeugE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_pushButton_bild_info_clicked"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_pushButton_bild_info_clicked'
    ...
    return QtMocHelpers::metaObjectData<Dialog_Werkzeug, qt_meta_tag_ZN15Dialog_WerkzeugE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dialog_Werkzeug::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15Dialog_WerkzeugE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15Dialog_WerkzeugE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15Dialog_WerkzeugE_t>.metaTypes,
    nullptr
} };

void Dialog_Werkzeug::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<Dialog_Werkzeug *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dialog_Werkzeug::*)(QString )>(_a, &Dialog_Werkzeug::sendDialogData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Werkzeug::*)(QString )>(_a, &Dialog_Werkzeug::sendDialogDataModifyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Werkzeug::*)(QString )>(_a, &Dialog_Werkzeug::signalSaveConfig, 2))
            return;
    }
}
...
void *Dialog_Werkzeug::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15Dialog_WerkzeugE_t>.strings))
