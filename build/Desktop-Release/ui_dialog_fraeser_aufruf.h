...
public:
    ...
    void setupUi(QDialog *Dialog_Fraeser_Aufruf)
    {
        if (Dialog_Fraeser_Aufruf->objectName().isEmpty())
            Dialog_Fraeser_Aufruf->setObjectName("Dialog_Fraeser_Aufruf");
        Dialog_Fraeser_Aufruf->resize(603, 658);
        Dialog_Fraeser_Aufruf->setModal(true);
        ...
        label__bahnkor_var->setObjectName("label__bahnkor_var");

        gridLayout->addWidget(label__bahnkor_var, 1, 1, 1, 1);

        comboBox__bahnkor = new QComboBox(layoutWidget);
        comboBox__bahnkor->setObjectName("comboBox__bahnkor");
        ...
        label_abftyp->setObjectName("label_abftyp");
        ...
        label_bezeichn->setObjectName("label_bezeichn");

        gridLayout_2->addWidget(label_bezeichn, 7, 0, 1, 1);

        label_komment = new QLabel(layoutWidget1);
        label_komment->setObjectName("label_komment");
        ...
        lineEdit_bezeichn->setObjectName("lineEdit_bezeichn");
        ...
        label_eintvors_var->setObjectName("label_eintvors_var");

        gridLayout_2->addWidget(label_eintvors_var, 1, 1, 1, 1);

        lineEdit_eintvors = new QLineEdit(layoutWidget1);
        lineEdit_eintvors->setObjectName("lineEdit_eintvors");
    ...
    {
        Dialog_Fraeser_Aufruf->setWindowTitle(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Fraeser-Aufruf", nullptr));
        label_kantdi->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Kantendicke", nullptr));
        label_startz->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Startpunkt Z", nullptr));
        label_startx->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Startpunkt X", nullptr));
        label_starty->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Startpunkt Y", nullptr));
        label_starty_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "*[Y]", nullptr));
        label__bahnkor_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[BKO]", nullptr));
        label_werkzeug->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Werkzeug", nullptr));
        label__werkzeug_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[WKZ]", nullptr));
        label_bahnkor->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Bahnkorrektur", nullptr));
        label_startz_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "*[Z]", nullptr));
        label_eckruglob->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Eckenrunden Global", nullptr));
        label__eckruglob_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "*[ERG]", nullptr));
        label_kantdi_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[KD]", nullptr));
        label__startx_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "*[X]", nullptr));
        label_bild_fraeser->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Bild des Fr\303\244sers", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("Dialog_Fraeser_Aufruf", "allgemein", nullptr));
        label_abftyp->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Abfahrtyp", nullptr));
        label_ausfbed_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "*[AFB]", nullptr));
        label_bezeichn->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Bezeichnung", nullptr));
        label_komment->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Kommentar", nullptr));
        label_vorschub->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Vorschub XY", nullptr));
        label_ausfbed->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Ausf\303\274hrbedingung", nullptr));
        label_drehzahl->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Drehzahl", nullptr));
        label_komment_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[KOM]", nullptr));
        label_bezeichn_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[BEZ]", nullptr));
        label_anftyp->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Anfahrtyp", nullptr));
        label_eintvors->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Eintauchvorschub", nullptr));
        label_abftyp_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[ANT]", nullptr));
        label_anftyp_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[ABT]", nullptr));
        label_drehzahl_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[N]", nullptr));
        label_vorschub_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[F]", nullptr));
        label_eintvors_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[FAN]", nullptr));
        label__zustellung->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Zustellmass", nullptr));
        label_zustellung_var->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "[ZUST]", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Technologie", nullptr));
        pushButton_abbrechen->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Abbrechen", nullptr));
        pushButton_speichern->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "Speichern", nullptr));
        pushButton_ok->setText(QCoreApplication::translate("Dialog_Fraeser_Aufruf", "OK", nullptr));
    } // retranslateUi
