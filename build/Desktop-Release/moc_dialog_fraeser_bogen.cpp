...
namespace {
struct qt_meta_tag_ZN20Dialog_fraeser_bogenE_t {};
} // unnamed namespace

template <> constexpr inline auto Dialog_fraeser_bogen::qt_create_metaobjectdata<qt_meta_tag_ZN20Dialog_fraeser_bogenE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Dialog_fraeser_bogen, qt_meta_tag_ZN20Dialog_fraeser_bogenE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dialog_fraeser_bogen::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20Dialog_fraeser_bogenE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20Dialog_fraeser_bogenE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN20Dialog_fraeser_bogenE_t>.metaTypes,
    nullptr
} };

void Dialog_fraeser_bogen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<Dialog_fraeser_bogen *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dialog_fraeser_bogen::*)(QString )>(_a, &Dialog_fraeser_bogen::sendDialogData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_fraeser_bogen::*)(QString )>(_a, &Dialog_fraeser_bogen::sendDialogDataModifyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_fraeser_bogen::*)(QString )>(_a, &Dialog_fraeser_bogen::signalSaveConfig, 2))
            return;
    }
}
...
void *Dialog_fraeser_bogen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20Dialog_fraeser_bogenE_t>.strings))
