...
namespace {
struct qt_meta_tag_ZN19Dialog_ProgrammkopfE_t {};
} // unnamed namespace

template <> constexpr inline auto Dialog_Programmkopf::qt_create_metaobjectdata<qt_meta_tag_ZN19Dialog_ProgrammkopfE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Dialog_Programmkopf, qt_meta_tag_ZN19Dialog_ProgrammkopfE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Dialog_Programmkopf::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19Dialog_ProgrammkopfE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19Dialog_ProgrammkopfE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19Dialog_ProgrammkopfE_t>.metaTypes,
    nullptr
} };

void Dialog_Programmkopf::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    auto *_t = static_cast<Dialog_Programmkopf *>(_o);
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Dialog_Programmkopf::*)(QString )>(_a, &Dialog_Programmkopf::sendDialogData, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Programmkopf::*)(QString )>(_a, &Dialog_Programmkopf::sendDialogDataModifyed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (Dialog_Programmkopf::*)(QString )>(_a, &Dialog_Programmkopf::signalSaveConfig, 2))
            return;
    }
}
...
void *Dialog_Programmkopf::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19Dialog_ProgrammkopfE_t>.strings))
