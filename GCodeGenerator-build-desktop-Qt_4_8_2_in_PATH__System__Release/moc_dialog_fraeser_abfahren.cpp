...
**
** Created: Sun Nov 26 14:35:43 2017
...
static const uint qt_meta_data_Dialog_fraeser_abfahren[] = {
...
static const char qt_meta_stringdata_Dialog_fraeser_abfahren[] = {
    "Dialog_fraeser_abfahren\0\0text\0"
...
void Dialog_fraeser_abfahren::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Dialog_fraeser_abfahren *_t = static_cast<Dialog_fraeser_abfahren *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData Dialog_fraeser_abfahren::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Dialog_fraeser_abfahren::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialog_fraeser_abfahren,
      qt_meta_data_Dialog_fraeser_abfahren, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Dialog_fraeser_abfahren::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_fraeser_abfahren))
        return static_cast<void*>(const_cast< Dialog_fraeser_abfahren*>(this));
